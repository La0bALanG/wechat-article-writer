...
**调用命令**：
```bash
python scripts/wecom_send_file.py --file "VSCode更名事件.md"
python scripts/wecom_send_file.py --file "cover.png"
```

#### 第9步：智能排版并上传至微信公众号草稿箱

**调用命令**：
```bash
python scripts/upload_to_wechat_draft.py "VSCode更名事件.md" "cover.png"
```
...
**调用命令**：
```bash
python scripts/wecom_send_file.py --file "LangChain框架介绍.md"
python scripts/wecom_send_file.py --file "cover.png"
python scripts/wecom_send_file.py --file "architecture.png"
```
...
**调用命令**：
```bash
python scripts/upload_to_wechat_draft.py "LangChain框架介绍.md" "cover.png"
```
